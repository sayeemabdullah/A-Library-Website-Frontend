        ...
        return (
            ...
            <div>
                ...
                <div>
                    ...
                    <button onClick={()=>this.setState({isRegistration: true})}>Don't have an account? Go to Registration</button>
                </div>
            </div>
            :
            <div>
            <img src={logo} style={{height:300}} ></img>
                <div>
                    ...
                    <button onClick={()=>this.setState({isRegistration: false})}>Already have an account? Go to login</button>
                </div>
            </div>
    }
            </div>
